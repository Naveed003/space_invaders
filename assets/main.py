...
# BG SCALING TO MATCH SCREEN SIZE
...
def main():
    ...
    lost_font = pygame.font.SysFont("comicsanse", 60)
    ...
    player = Player(300, 630)  # co-ordinates for starting ship
...
def main_menu():
    ...
    while True:
        ...
        title_label = title_font.render(
            "press the mouse key to begin", 1, (255, 255, 255))
